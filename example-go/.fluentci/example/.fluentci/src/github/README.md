...
```bash
fluentci gh init -t buck_pipeline
```

Or, if you already have a `.fluentci` folder (generated from `fluentci init -t buck`) in your project:
  ...
  test:
    ...
    steps:
      ...
      - name: Run Dagger Pipelines
        run: fluentci run buck_pipeline
